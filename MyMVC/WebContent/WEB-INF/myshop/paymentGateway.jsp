...
$(document).ready(function() {
   ...
   IMP.init('imp94551965');  // 중요!!  아임포트에 가입시 부여받은 "가맹점 식별코드". 
   ...
   IMP.request_pay({
       ...
       buyer_addr : '',  
       buyer_postcode : '',
       m_redirect_url : '192.168.50.21:9090/MyMVC/coinAddUpdateLoginuser.do?idx=${idx}'  // 휴대폰 사용시 결제 완료 후 action : 컨트롤러로 보내서 자체 db에 입력시킬것!
   }, function(rsp) {
       /*
		   if ( rsp.success ) {
			   var msg = '결제가 완료되었습니다.';
	   ...
	   */
		...
		*/
		...
		//	window.opener.goCoinUpdate('${idx}','${coinmoney}');
			window.opener.goCoinUpdate('${idx}');
