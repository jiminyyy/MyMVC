...
public class GoogleMail {
    ...
    public void sendmail(String recipient, String certificationCode)  
    	...
    	prop.put("mail.smtp.user", "knowledge0223@gmail.com");
    	...
    	// 보내는 사람의 메일주소
    	String sender = "knowledge0223@gmail.com";
    ...
    public void sendmail_DeliverStartFinish(String recipient, String name, String emailContents)  
    		throws Exception{
    	...
    	// 제목 설정
    	String subject = "localhost:9090/MyMVC/mallHome.do"+name+"회원님의 상품이 배송시작되었습니다. ";
    	msg.setSubject(subject);
